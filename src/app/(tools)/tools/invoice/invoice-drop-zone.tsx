...
export function InvoiceDropZone({ onCreated }: InvoiceDropZoneProps) {
  ...
  async function processFile(file: File) {
    if (!ACCEPTED_MIME_TYPES.includes(file.type)) {
      toast.error(
        `Unsupported file type. Accepted: PDF, JPG, PNG, WEBP.`
      );
      return;
    }
            ...
            <div className="grid gap-3 py-2">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-sm font-medium" htmlFor="rv-merchant">
                    Merchant
                  </label>
                  <Input
                    id="rv-merchant"
                ...
                <div className="space-y-1">
                  <label className="text-sm font-medium" htmlFor="rv-date">
                    Date
                  </label>
                  <Input
                    id="rv-date"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-sm font-medium" htmlFor="rv-amount">
                    Amount
                  </label>
                  <Input
                    id="rv-amount"
                ...
                <div className="space-y-1">
                  <label className="text-sm font-medium" htmlFor="rv-currency">
                    Currency
                  </label>
                  <Input
                    id="rv-currency"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-sm font-medium" htmlFor="rv-tax">
                    Tax
                  </label>
                  <Input
                    id="rv-tax"
                ...
                <div className="space-y-1">
                  <label className="text-sm font-medium" htmlFor="rv-category">
                    Category
                  </label>
                  <Input
                    id="rv-category"
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium" htmlFor="rv-description">
                  Description
                </label>
                <Textarea
                  id="rv-description"
